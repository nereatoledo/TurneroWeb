...
public interface TurnoRepository extends CrudRepository<Turno, Integer>, PagingAndSortingRepository<Turno, Integer> {
       ...
       List<Turno> find(@Param("fecha") LocalDate fecha, @Param("consultorioId") int consultorioId,
       ...
       List<Turno> find(@Param("fecha") LocalDate fecha, @Param("consultorioId") Integer consultorioId,
                     @Param("medicoId") Integer medicoId, @Param("pacienteId") Integer pacienteId,
                     @Param("estados") List<EstadoTurno> estados);
       ...
       @Query("SELECT t FROM Turno t WHERE " +
                     ...
                     "AND (:medicoId IS NULL OR t.medico.id = :medicoId)")
       Page<Turno> search(@Param("fecha") LocalDate fecha, @Param("estado") EstadoTurno estado,
                     @Param("pacienteId") Integer pacienteId, @Param("especialidadId") Integer especialidadId,
                     @Param("medicoId") Integer medicoId, Pageable pageable);
