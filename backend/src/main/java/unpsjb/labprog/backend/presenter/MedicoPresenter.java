...
public class MedicoPresenter {
  ...
  @Autowired EspecialidadService especialidadService;
  ...
  public ResponseEntity<Object> search(
    ...
    return Response.ok(service.search(term, especialidadId, centroId));
  }
  ...
  public ResponseEntity<Object> create(@RequestBody Medico medico) {
    ...
    if (!medico.getDni().matches("\\d+")) {
      return Response.response(
          HttpStatus.CONFLICT, "dni incorrecto, débe contener sólo números", null);
    }
