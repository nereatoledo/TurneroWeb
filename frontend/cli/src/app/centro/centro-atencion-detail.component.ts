          ...
          <div class="row">
            <div class="form-group mb-3 col-md-6">
              ...
              <input 
                ...
                #latitud="ngModel"
              />
              <div *ngIf="latitud.invalid && (latitud.dirty || latitud.touched)" class="text-danger">
            ...
            <div class="form-group mb-3 col-md-6">
              ...
              <input 
                ...
                #longitud="ngModel"
              />
              <div *ngIf="longitud.invalid && (longitud.dirty || longitud.touched)" class="text-danger">
...
export class CentroAtencionDetailComponent implements OnInit {
  ...
  constructor(
    private service: CentroAtencionService,
  ...
  get(): void {
    ...
    if (id && id !== 'new') {
      this.service.get(id).subscribe(dataPackage => {
  ...
  save(): void {
    this.service.crear(this.centro_atencion).subscribe((dataPackage) => {
      this.modalService.confirm(
        "¡Éxito!", 
        "Centro guardado correctamente.", 
        ""
      ),
      this.goBack(); 
      });
